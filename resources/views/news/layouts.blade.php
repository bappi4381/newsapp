...
<html class="no-js" lang="zxx">
    <head>
		...
		<link rel="shortcut icon" type="image/x-icon" href="{{ asset('/') }}assetsimg/favicon.ico">
                       ...
                       <div class="col-xl-12">
                            <div class="row d-flex justify-content-between align-items-center">
                                <div class="header-info-left">
                                    @php
                                        $city = 'Dhaka';
                                        $apiKey = env('OPENWEATHER_API_KEY'); // Make sure this is correct
                                        if($apiKey) {
                                            $weatherJson = @file_get_contents("http://api.openweathermap.org/data/2.5/weather?q={$city}&units=metric&appid={$apiKey}");
                                            $weather = $weatherJson ? json_decode($weatherJson) : null;
                                        } else {
                                            $weather = null;
                                        }
                                    @endphp
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            {{ $weather ? round($weather->main->temp) . 'ºC, ' . $weather->weather[0]->main : 'N/A' }}
                                        </li>
                                        <li>
                                            <img src="{{ asset('assets/img/icon/header_icon1.png') }}" alt="">
                                ...
                                <div class="footer-form" >
                                    <div id="mc_embed_signup">
                                        ...
                                        method="get" class="subscribe_form relative mail_part">
                                            ...
                                            class="email_icon newsletter-submit button-contactForm"><img src="{{ asset('/') }}assetsimg/logo/form-iocn.png" alt=""></button>
                                            </div>
